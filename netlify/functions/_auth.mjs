...
export function sessionCookie(token){return`pm_session=${encodeURIComponent(token)}; Path=/; HttpOnly; Secure; SameSite=Strict; Max-Age=${TTL}`}
export function clearSessionCookie(){return'pm_session=; Path=/; HttpOnly; Secure; SameSite=Strict; Max-Age=0'}
